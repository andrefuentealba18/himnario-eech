...
import { ChevronLeft, ZoomIn, ZoomOut, Printer, Users } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="print-header-oficial">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-0.5">
            <p className="text-sm font-bold uppercase text-slate-600">{youthChoir.group}</p>
        ...
        <div className="ml-auto text-right">
          <div className="relative inline-block px-4">
            <span className="text-5xl font-serif text-slate-400 leading-none">AG</span>
      ...
      <main className="flex-1 py-8 px-4 flex flex-col justify-center items-center">
        ...
        <div className="hidden print:block text-center mb-10 w-full">
          <h1 className="text-3xl font-bold uppercase tracking-tight mb-2">{youthChoir.title}</h1>
          <p className="text-lg font-medium text-gray-600">{youthChoir.group} {youthChoir.tone ? `• ${youthChoir.tone}` : ''} {youthChoir.speed ? `• ${youthChoir.speed}` : ''}</p>
