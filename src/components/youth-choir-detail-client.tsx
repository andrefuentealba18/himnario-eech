  ...
  return (
    <div className="flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <header className="sticky top-0 z-20 flex items-center justify-between bg-background/60 backdrop-blur-md pt-24 pb-6 px-4 border-b">
        ...
        <div className="flex-1 flex flex-col items-center justify-center overflow-hidden px-2">
            ...
            <div className="flex items-center justify-center gap-2 mt-1">
                ...
                {youthChoir.speed && (
                    <Badge variant="secondary" className="text-[10px] font-bold capitalize rounded-full px-2 py-0.5 bg-slate-100 dark:bg-white/5 border border-slate-200/50">
      ...
      <main className="flex-1 py-10 px-4 flex flex-col items-center justify-start overflow-y-auto relative">
        {groupLogo && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none -z-10 opacity-[0.12] dark:opacity-[0.08] scale-110 sm:scale-100">
            <Image 
              src={groupLogo} 
              alt="Watermark" 
              width={600} 
