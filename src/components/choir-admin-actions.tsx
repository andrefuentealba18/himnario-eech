    ...
    <Dialog open={dialogOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className={isAuthenticated ? "sm:max-w-lg rounded-[2.5rem]" : "w-[95vw] max-w-[320px] rounded-[2.5rem] p-0 border-none shadow-2xl bg-white/95 dark:bg-slate-950/95 backdrop-blur-2xl overflow-hidden"} onCloseAutoFocus={(e) => e.preventDefault()}>
        {!isAuthenticated ? (
          <div className="p-8">
            <DialogHeader className="text-center space-y-4">
              ...
              <div className="space-y-1">
                <DialogTitle className="text-xl font-black uppercase tracking-tight">Acceso Admin</DialogTitle>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onPasswordSubmit)} className="space-y-6 py-6">
                ...
                />
                <Button type="submit" className="w-full rounded-[1rem] h-14 font-black uppercase tracking-widest shadow-lg shadow-primary/20">
                  Entrar
                </Button>
              </form>
            </Form>
          ...
          <div className="p-6">
            <DialogHeader>
              <DialogTitle className="font-headline text-2xl font-bold">Administrar Coro</DialogTitle>
              <DialogDescription className="text-sm">¿Qué deseas hacer con "{choir.title}"?</DialogDescription>
            </DialogHeader>
