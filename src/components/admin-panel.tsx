      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="p-4 space-y-6">
          ...
          <Tabs value={tab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-4 md:grid-cols-7 h-auto bg-muted/50 p-1 rounded-xl gap-1">
            ...
            <TabsContent value="special" className="mt-4">
              <Card><CardHeader><CardTitle>Ocasiones Especiales</CardTitle></CardHeader>
              <CardContent><p className="text-sm text-muted-foreground">Gestiona los cantos de Bautismos, Matrimonios, etc.</p></CardContent></Card>
            </TabsContent>
            <TabsContent value="more-settings" className="mt-4"><div className="space-y-6"><DuplicateSongsManager /><MissingHymns /><SongTransferManager /><BackupManager /></div></TabsContent>
          </Tabs>
        </div>
      </div>
  );
