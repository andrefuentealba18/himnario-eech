      ...
      <div className="fixed inset-0 z-[100] bg-white flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative flex flex-col items-center">
          <div className="space-y-4 text-center">
            ...
            <h1 className="text-5xl font-black font-headline tracking-[0.3em] text-primary animate-in fade-in zoom-in-95 duration-1000 ease-out uppercase text-glow">
              Himnos
            </h1>
  ...
  return (
    <main className="relative flex flex-col items-center bg-background min-h-screen overflow-x-hidden animate-in fade-in duration-1000">
      ...
      <div className="w-full max-w-2xl mx-auto flex flex-col h-screen">
        <header className="sticky top-0 z-20 bg-background/60 backdrop-blur-xl pt-32 pb-8 px-4 border-b flex flex-col items-center gap-4 transition-all duration-500">
