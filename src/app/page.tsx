          ...
          <header className="w-full text-center space-y-8 mb-16 animate-in fade-in slide-in-from-top-8 duration-1000">
            <div className="relative inline-flex items-center justify-center group">
              ...
              <div className="relative p-1 bg-gradient-to-tr from-primary via-primary/60 to-primary/40 rounded-full shadow-2xl animate-float group-hover:scale-105 transition-transform duration-700">
                <div className="bg-white dark:bg-slate-900 rounded-full p-1 overflow-hidden flex items-center justify-center w-28 h-28 md:w-36 md:h-36">
                  <Image 
                    src={insigniaUrl} 
                    alt="Insignia EECH" 
                    width={144} 
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-center gap-3 text-primary/40 mb-3">
              ...
              <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 font-bold tracking-[0.6em] uppercase pt-6 opacity-70">
              ...
              <div key={item.title} className="animate-in fade-in zoom-in-95 duration-700" style={{ animationDelay: item.delay }}>
                <Link href={item.href} className="group block h-full">
                  <Card className="h-full border-none bg-white/40 dark:bg-white/[0.03] backdrop-blur-xl hover:bg-white/80 dark:hover:bg-white/[0.08] transition-all duration-500 hover:-translate-y-2 active:scale-95 overflow-hidden relative group app-card card-glow">
                    ...
                    <CardContent className="flex flex-col items-center justify-center p-8 text-center h-full min-h-[180px] relative z-10">
                      <div className={`p-5 bg-white dark:bg-slate-900 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 mb-6`} style={{ borderRadius: 'var(--ui-radius)' }}>
                        <item.icon className={`h-8 w-8 ${item.iconColor}`} />
                      </div>
                      <h3 className="font-black text-[11px] md:text-[12px] uppercase tracking-[0.25em] font-body text-slate-800 dark:text-slate-200 group-hover:text-primary transition-colors leading-tight">
                        {item.title}
                      </h3>
                    </CardContent>
                  </Card>
            ...
            <div className="flex flex-col items-center gap-10">
              ...
              <div className="space-y-5 pb-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[8px] font-black text-primary/40 uppercase tracking-[0.2em] border border-primary/10 rounded-full px-5 py-2 inline-block">
